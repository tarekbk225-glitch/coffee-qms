...
import { createAsset, type ActionResult } from "../actions";
...
import { assetCriticalityLabels } from "@/lib/labels";
...
export function NewAssetForm({ sites, departments, areas }: { sites: Option[]; departments: Option[]; areas: Option[] }) {
        ...
        <form action={formAction} className="flex flex-col gap-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="name_ar">اسم المعدة (بالعربية)</Label>
              <Input id="name_ar" name="name_ar" placeholder="محمصة القهوة الرئيسية" required />
            </div>
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="name">الاسم بالإنجليزية (اختياري)</Label>
              <Input id="name" name="name" dir="ltr" placeholder="Main Coffee Roaster" />
            </div>
          </div>

          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="asset_code">رمز الأصل (اختياري)</Label>
              <Input id="asset_code" name="asset_code" dir="ltr" placeholder="سيتم توليده تلقائيًا إن تُرك فارغًا" />
            </div>
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="category">الفئة</Label>
              <Input id="category" name="category" placeholder="roasting / packing / warehouse ..." defaultValue="general" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <Input id="model" name="model" dir="ltr" />
            </div>
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="serial_number">الرقم التسلسلي</Label>
              <Input id="serial_number" name="serial_number" dir="ltr" />
            </div>
          </div>
